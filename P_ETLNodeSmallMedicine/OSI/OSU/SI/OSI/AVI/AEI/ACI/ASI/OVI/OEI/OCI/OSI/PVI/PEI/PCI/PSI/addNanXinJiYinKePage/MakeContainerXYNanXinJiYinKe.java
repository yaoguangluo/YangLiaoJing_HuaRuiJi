...
public class MakeContainerXYNanXinJiYinKe extends Thread implements Runnable{
	...
	public MakeContainerXYNanXinJiYinKe(A _A, Container jpanelSecond, App u2, JTabbedPane jTabbedpane
	...
	public void run(){ 
		try {
			...
			Thread.sleep(1000*3);
			tabNames.add("男性基因科");
			jpanelSecond= new NanXinJiYinKekx(u.text, this._A, pos, pose, etc, cte, jTabbedpane, u);
			jpanelSecond.setName("男性基因科");
			
//			u.jpanel11 = new MakeContainerXYNanXinJiYinKe(u.text, this._A, pos, pose, etc, cte, jTabbedpane, u);
