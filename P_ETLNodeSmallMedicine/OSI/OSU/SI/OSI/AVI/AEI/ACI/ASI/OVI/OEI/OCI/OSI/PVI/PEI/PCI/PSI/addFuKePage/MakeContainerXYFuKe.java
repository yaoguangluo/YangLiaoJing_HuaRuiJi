...
public class MakeContainerXYFuKe extends Thread implements Runnable{
	...
	public MakeContainerXYFuKe(A _A, Container jpanelSecond, App u2, JTabbedPane jTabbedpane
	...
	public void run(){ 
		try {
			...
			Thread.sleep(1000*3);
			tabNames.add("西医妇科");
			jpanelSecond= new FuKekx(u.text, this._A, pos, pose, etc, cte, jTabbedpane, u);
			jpanelSecond.setName("西医妇科");
			
//			u.jpanel11 = new MakeContainerXYFuKe(u.text, this._A, pos, pose, etc, cte, jTabbedpane, u);
