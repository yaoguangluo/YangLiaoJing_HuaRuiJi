...
public class MakeContainerXYChanKe extends Thread implements Runnable{
	...
	public MakeContainerXYChanKe(A _A, Container jpanelSecond, App u2, JTabbedPane jTabbedpane
	...
	public void run(){ 
		try {
			...
			Thread.sleep(1000*3);
			tabNames.add("西医产科");
			jpanelSecond= new ChanKekx(u.text, this._A, pos, pose, etc, cte, jTabbedpane, u);
			jpanelSecond.setName("西医产科");
			
//			u.jpanel11 = new MakeContainerXYChanKe(u.text, this._A, pos, pose, etc, cte, jTabbedpane, u);
