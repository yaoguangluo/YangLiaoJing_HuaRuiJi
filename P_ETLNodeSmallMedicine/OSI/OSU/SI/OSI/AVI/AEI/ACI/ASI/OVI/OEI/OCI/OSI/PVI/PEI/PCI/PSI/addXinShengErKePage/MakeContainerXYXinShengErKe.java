...
public class MakeContainerXYXinShengErKe extends Thread implements Runnable{
	...
	public MakeContainerXYXinShengErKe(Analyzer analyzer, Container jpanelSecond, App u2, JTabbedPane jTabbedpane
	...
	public void run(){ 
		try {
			...
			Thread.sleep(1000*3);
			tabNames.add("新生儿科");
			jpanelSecond= new XinShengErKekx(u.text, this.analyzer, pos, pose, etc, cte, jTabbedpane, u);
			jpanelSecond.setName("新生儿科");
			
//			u.jpanel11 = new MakeContainerXYXinShengErKe(u.text, this.analyzer, pos, pose, etc, cte, jTabbedpane, u);
//			u.jpanel11.setName(tabNames.get(10));
			jTabbedpane.addTab("新生儿科", new ImageIcon() ,jpanelSecond, "添加西医新生儿科页");// �����һ��ҳ��  
