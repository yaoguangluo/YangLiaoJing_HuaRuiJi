...
public class MakeContainerXYXinShengErKe extends Thread implements Runnable{
	...
	public MakeContainerXYXinShengErKe(A _A, Container jpanelSecond, App u2, JTabbedPane jTabbedpane
	...
	public void run(){ 
		try {
			...
			Thread.sleep(1000*3);
			tabNames.add("新生儿科");
			jpanelSecond= new XinShengErKekx(u.text, this._A, pos, pose, etc, cte, jTabbedpane, u);
			jpanelSecond.setName("新生儿科");
			
//			u.jpanel11 = new MakeContainerXYXinShengErKe(u.text, this._A, pos, pose, etc, cte, jTabbedpane, u);
