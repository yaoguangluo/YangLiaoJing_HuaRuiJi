...
public class MakeContainerXYMaZuiKe extends Thread implements Runnable{
	...
	public MakeContainerXYMaZuiKe(Analyzer analyzer, Container jpanelSecond, App u2, JTabbedPane jTabbedpane
	...
	public void run(){ 
		try {
			...
			Thread.sleep(1000*3);
			tabNames.add("麻醉科");
			jpanelSecond= new MaZuiKekx(u.text, this.analyzer, pos, pose, etc, cte, jTabbedpane, u);
			jpanelSecond.setName("麻醉科");
			
//			u.jpanel11= new MakeContainerXYMaZuiKe(u.text, this.analyzer, pos, pose, etc, cte, jTabbedpane, u);
