...
public class MakeContainerXYPuWaiKe extends Thread implements Runnable{
	...
	public MakeContainerXYPuWaiKe(A _A, Container jpanelSecond, App u2, JTabbedPane jTabbedpane
	...
	public void run(){ 
		try {
			...
			Thread.sleep(1000*3);
			tabNames.add("普外科");
			jpanelSecond= new PuWaiKekx(u.text, this._A, pos, pose, etc, cte, jTabbedpane, u);
			jpanelSecond.setName("普外科");
			
//			u.jpanel11 = new MakeContainerXYPuWaiKe(u.text, this._A, pos, pose, etc, cte, jTabbedpane, u);
