...
public class MakeContainerXYXinWaiKe extends Thread implements Runnable{
	...
	public MakeContainerXYXinWaiKe(A _A, Container jpanelSecond, App u2, JTabbedPane jTabbedpane
	...
	public void run(){ 
		try {
			...
			Thread.sleep(1000*3);
			tabNames.add("心外科");
			jpanelSecond= new XinWaiKekx(u.text, this._A, pos, pose, etc, cte, jTabbedpane, u);
			jpanelSecond.setName("心外科");
			
//			u.jpanel11 = new MakeContainerXYXinWaiKe(u.text, this._A, pos, pose, etc, cte, jTabbedpane, u);
