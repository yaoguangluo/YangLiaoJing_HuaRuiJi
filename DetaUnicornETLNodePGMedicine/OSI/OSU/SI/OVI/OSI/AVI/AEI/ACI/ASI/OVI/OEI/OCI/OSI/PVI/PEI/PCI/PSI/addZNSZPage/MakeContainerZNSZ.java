...
public class MakeContainerZNSZ extends Thread implements Runnable{
	...
	public MakeContainerZNSZ(Analyzer analyzer, Container jpanelFourth, App u2, JTabbedPane jTabbedpane
	...
	public void run(){ 
		try {
			...
			sliderBox2.add(new   Label("Ƶ��002HZ"));
			sliderBox3.add(new   Label("Ƶ��003HZ"));
			sliderBox4.add(new   Label("Ƶ��004HZ"));
			sliderBox5.add(new   Label("Ƶ��005HZ"));
			sliderBox6.add(new   Label("Ƶ��006HZ"));
			sliderBox8.add(new   Label("Ƶ��008HZ"));
			sliderBox16.add(new  Label("Ƶ��016HZ"));
			sliderBox32.add(new  Label("Ƶ��032HZ"));
			sliderBox64.add(new  Label("Ƶ��064HZ"));
			sliderBox128.add(new Label("Ƶ��128HZ"));
			sliderBox256.add(new Label("Ƶ��256HZ"));
			sliderBox512.add(new Label("Ƶ��512HZ"));
			...
			jTabbedpane.addTab(tabNames.get(3),new ImageIcon() , jpanelFourth, "��������");// �����һ��ҳ��  
