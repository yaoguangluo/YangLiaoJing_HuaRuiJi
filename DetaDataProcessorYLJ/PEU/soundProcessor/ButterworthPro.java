...
public class ButterworthPro{
	...
	public Vector getVectorLines(AudioInputStream ais1){
		...
		lap[3]=1;
		lap[4]=0;
		butterworth=new double[audioData.length];
		double sum=0;
		...
		for (double x = 0; x < w && audioData != null; x++) {
			...
			if (af.getSampleSizeInBits() == 8) {
				my_byte = (byte) butterworth[idx];
			} else {
				my_byte = (byte)(128*butterworth[idx]/32768);
			}
