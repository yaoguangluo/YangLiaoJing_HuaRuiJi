...
public class EditPanelReaderPanel extends OSU_AVQ_ASQ_AOI_AOD_AOU_AOQ_VES{
	private static final long serialVersionUID = 1L;
	private JTextPane textTemp;
	public EditPanelReaderPanel(final EditPanelReaderRun SQ_OSU_MSQ_OSU_AVQ_ASQ_OPE_OPC_ECI, JTextPane text){
		this.textTemp = text;
		setLayout(null);
