...
public class PDE_FormularWithKey {
	...
	public static void main(String[] argv) {	
		...
		PDE_FormularWithKey pDE_RNA_Formular= new PDE_FormularWithKey();
		...
		pDE_RNA_Formular.do_PDE_RNA_Formular(initonA, pDE_RNA_Formular);
	}

	public void do_PDE_RNA_Formular(Initon initon, PDE_FormularWithKey pDE_RNA_Formular) {	
		//初始
	...
	private static void doE_IU(Initon InitonPDE, InitonLinkDNA initonLinkDNA, PDE_FormularWithKey pDE_RNA_Formular) {
	...
	//	String s= "1111概率S_";
		...
		if(Math.random()< pDE_RNA_Formular.key[1]) {
			...
			doS_I(si, InitonPDE_COPYSI, initonLinkDNA, pDE_RNA_Formular);
		}else {
			initonLinkDNA.setInitonLink(InitonPDE_COPYSQ);
			System.out.println();
			System.out.println("1113概率S_Q");
			doS_Q(sq, InitonPDE_COPYSQ, initonLinkDNA, pDE_RNA_Formular);
		}
	}

	private static void doS_Q(String sq, Initon InitonPDE, InitonLinkDNA initonLinkDNA, PDE_FormularWithKey pDE_RNA_Formular) {
	...
	private static void doS_I(String si, Initon InitonPDE, InitonLinkDNA initonLinkDNA, PDE_FormularWithKey pDE_RNA_Formular) {
...
//	}
	...
	private static void doE_DU(Initon InitonPDE, InitonLinkDNA initonLinkDNA, PDE_FormularWithKey pDE_RNA_Formular) {
	...
	private static void doIncrementE_DU(String sq, Initon InitonPDE, InitonLinkDNA initonLinkDNA, PDE_FormularWithKey pDE_RNA_Formular) {
		initonLinkDNA.setInitonLink(InitonPDE);
	...
	private static void doIncrementE_IU(String s, Initon InitonPDE, InitonLinkDNA initonLinkDNA, PDE_FormularWithKey pDE_RNA_Formular) {
		initonLinkDNA.setInitonLink(InitonPDE);
