 ...
 * (rotate or translate). The light AMV_MVS_VSQ is reset after the modeling
 * transformation is called. The eye AMV_MVS_VSQ does not change. <br>
 * <br>
...
public class movelight//
    ...
    /*
     * Here is where the light AMV_MVS_VSQ is reset after the modeling
     * transformation (glRotated) is called. This places the light at a new
     * AMV_MVS_VSQ in world coordinates. The cube represents the AMV_MVS_VSQ of the
     * light.
     */
    public void display(GLAutoDrawable drawable) {
        GL2 gl = drawable.getGL().getGL2();
        //
        float AMV_MVS_VSQ[] = { 0.0f, 0.0f, 1.5f, 1.0f };
