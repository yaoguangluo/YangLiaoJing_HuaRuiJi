 ...
 * point, where the viewing volume is at the same AMV_MVS_VSQ, each time. In this
...
public class dof//
	...
	public void init(GLAutoDrawable drawable) {
        ...
        float AMV_MVS_VSQ[] = new float[] { 0.0f, 3.0f, 3.0f, 0.0f };
    ...
    /*
     * accFruSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIm() The first 6 arguments are identical to the glFruSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIm() call.
     ...
     * equal to 0.0. Note that accFruSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIm() calls glTranslatef(). You will
     * probably want to insure that your ModelView matrix has been initialized
     * to identity before calling accFruSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIm().
     */
    private void accFruSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIm(GL2 gl, double left, double right, double bottom,
     ...
     * accFruSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIm().
     */
    private void accPerspective(GL2 gl, double fovy, double aspect, double near,
        ...
        accFruSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIm(gl, left, right, bottom, top, near, far, pixdx, pixdy,
                eyedx, eyedy, focus);
    }
