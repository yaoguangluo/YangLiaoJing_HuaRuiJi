package OSI.OPE.OP.SM.AOP.MEC.SIQ.stable;
public interface StableData {
	...
	public static final String REST_PATH_MEDICINEZY = "/dataZY";
	public static final String REST_PATH_MEDICINEXY = "/dataXY";
	public static final String REST_PATH_MEDICINEZT = "/dataZT";
	public static final String REST_PATH_MEDICINEXT = "/dataXT";
	public static final String REST_PATH_MEDICINEYT = "/dataYT";
	public static final String REST_PATH_SEARCH = "/search";
}
