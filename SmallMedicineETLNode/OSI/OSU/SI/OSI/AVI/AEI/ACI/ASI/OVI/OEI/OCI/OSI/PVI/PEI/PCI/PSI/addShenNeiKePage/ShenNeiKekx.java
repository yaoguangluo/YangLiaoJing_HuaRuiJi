...
public class ShenNeiKekx extends Container implements MouseListener, KeyListener{
	...
	private int row;
	public ShenNeiKekx(JTextPane text, Analyzer analyzer, Map<String, String> pos, Map<String, String> pose
