...
public class WizardDialog extends JMDialog /*implements WindowListener, ActionListener*/ {
    ...
    public static final String		ACTION_FINISH = JMFI18N.getResource("jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.wizard.finish");
    public static final String		ACTION_CANCEL = JMFI18N.getResource("jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.wizard.cancel");
    public static final String		ACTION_NEXT = JMFI18N.getResource("jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.wizard.next");
    public static final String		ACTION_BACK = JMFI18N.getResource("jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.wizard.back");
