...
public class JMAppsCfg {
    ...
    public static final String  KEY_JMSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIDIO_FRAME_POS = "Location of JMSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio Frame";
    ...
    private static final String         signatureFileCfg = "JMSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio configuration data file.";
    ...
    @SuppressWarnings("rawtypes")
	public Point getJMSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdioFrameLocation ( int nFrameIndex ) {
        int     nCount;
        int     nIndex;
        Object  objValue;
        ...
        objValue = hashProperties.get ( KEY_JMSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIDIO_FRAME_POS );
        if ( objValue != null  &&  objValue instanceof Vector ) {
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
	public void setJMSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdioFrameLocation ( Point pointValue, int nFrameIndex ) {
        int     nCount;
        Object  objValue;
        Vector  vectorValues = null;
        ...
        if ( objValue != null  &&  objValue instanceof Vector ) {
            ...
            hashProperties.put ( KEY_JMSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIDIO_FRAME_POS, vectorValues );
        }
	...
	private void readFile () {
        ...
        try {
            ...
            MessageDialog.createErrorDialog ( null,
                                JMFI18N.getResource("jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.error.cfgfile.read"),
                                exception );
        }
        ...
        try {
            ...
            MessageDialog.createErrorDialog ( null,
                                JMFI18N.getResource("jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.error.cfgfile.close"),
                                exception );
        }
    }
...
//            MessageDialog.createErrorDialog ( null,
//                                JMFI18N.getResource("jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.error.cfgfile.create"),
//                                exception );
            System.out.println ( JMFI18N.getResource("jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.error.cfgfile.create")
        ...
        try {
            ...
            MessageDialog.createErrorDialog ( null,
                                JMFI18N.getResource("jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.error.cfgfile.write"),
                                exception );
        }
