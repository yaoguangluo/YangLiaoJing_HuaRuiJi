...
public class PerTypePanel extends JMPanel implements VectorEditor {
    ...
    private static boolean checkIfJDK12() {
        ...
        try {
            ...
            //下面三行没检查 罗瑶光
            getSystemClassLoaderM = ClassLoader.class.getMethod ( "getSystemClassLoader", Class.class );
            // TODO: may need to invoke RuntimePermission("getClassLoader") privilege
            systemClassLoader = (ClassLoader) getSystemClassLoaderM.invoke ( ClassLoader.class,  Class.class );
            getContextClassLoaderM = Thread.class.getMethod ( "getContextClassLoader",  Class.class );
        }
        catch (Throwable t) {
            forName3ArgsM = null;
            return false;
	...
	static Class getClassForName ( String className )
        ...
        try {
            // TODO: may need to invoke RuntimePermission("getClassLoader") privilege
            ClassLoader contextClassLoader = (ClassLoader) getContextClassLoaderM.invoke ( Thread.currentThread(), Class.class );
            return (Class) forName3ArgsM.invoke(Class.class, new Object[] {
