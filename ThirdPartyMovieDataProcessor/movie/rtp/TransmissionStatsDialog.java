...
public class TransmissionStatsDialog extends JMDialog {
    ...
    private static final String     LABEL_TOTAL_RTP_PACKETS_SENT    = JMFI18N.getResource ( "jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.transmitstats.totalrtppacketssent" );
    private static final String     LABEL_TOTAL_BYTES_SENT          = JMFI18N.getResource ( "jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.transmitstats.totalbytessent" );
    private static final String     LABEL_RTCP_PACKETS_SENT         = JMFI18N.getResource ( "jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.transmitstats.rtcppacketssent" );
    private static final String     LABEL_LOCAL_COLLISIONS          = JMFI18N.getResource ( "jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.transmitstats.localcollisions" );
    private static final String     LABEL_REMOTE_COLLISIONS         = JMFI18N.getResource ( "jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.transmitstats.remotecollisions" );
    private static final String     LABEL_FAILED_TRANSMISSIONS      = JMFI18N.getResource ( "jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.transmitstats.failedtransmissions" );


    @SuppressWarnings("rawtypes")
	public TransmissionStatsDialog ( Frame frame, Vector vectorMngrSessions, Vector vectorStreamLabels ) {
	    super ( frame, JMFI18N.getResource("jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.transmitstats.title"), false );
