...
public class ViewSenderReport extends JMPanel {
    ...
    private static final String LABEL_SSRC              = JMFI18N.getResource ( "jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.rtpsessionctrl.report.ssrc" );
    private static final String LABEL_NTP_TIMESTAMP_LSW = JMFI18N.getResource ( "jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.rtpsessionctrl.report.ntptimestamplsw" );
    private static final String LABEL_NTP_TIMESTAMP_MSW = JMFI18N.getResource ( "jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.rtpsessionctrl.report.ntptimestampmsw" );
    private static final String LABEL_RTP_TIMESTAMP     = JMFI18N.getResource ( "jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.rtpsessionctrl.report.rtptimestamp" );
    private static final String LABEL_BYTES             = JMFI18N.getResource ( "jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.rtpsessionctrl.report.bytecount" );
    private static final String LABEL_PACKETS           = JMFI18N.getResource ( "jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.rtpsessionctrl.report.packetcount" );
