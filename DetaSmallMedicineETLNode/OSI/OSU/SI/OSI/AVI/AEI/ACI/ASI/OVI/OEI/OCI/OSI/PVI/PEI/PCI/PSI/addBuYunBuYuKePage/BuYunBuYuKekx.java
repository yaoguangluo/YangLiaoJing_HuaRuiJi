...
public class BuYunBuYuKekx extends Container implements MouseListener, KeyListener{
	...
	private int row;
	public BuYunBuYuKekx(JTextPane text, Analyzer analyzer, Map<String, String> pos, Map<String, String> pose
