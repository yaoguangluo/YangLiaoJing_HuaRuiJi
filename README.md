...
###### 非卷积语义元基视觉, 见工程文件  AVQ.OEQ.cap.Monitor.java 1022行起始等
###### 语义元基session, 见工程文件 OSI.OSU.MSU.tcp.http.SessionValidation.java
###### 非生化语义元基加密, 见工程文件 ME.APM.VSQ.DictionaryFromDB.java
###### 语义肽展搜索, 见工程文件 OSI.OSU.VSQ.dna.search.ZhongYaoSearch.java 
