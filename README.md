...
###### 1.1> Win 32位也可以研发,不过 第三方的语音等API,请到maven 去下32位的.
###### 2> 内存4 GB 以上皆可.
###### 3> 硬盘50 GB 以上皆可.
###### 4> 普通显卡1GB 以上皆可.
###### 5> 1200*800 以上像素显示皆可.
...
###### 2将DetaPLSQLDatabase项目目录下的DBconfig.zip文件解压缩在C盘下即可（注意路径名，去掉 副本 两个字），文件我已经裁掉了850个中药属性和 1550个西药属性，仅做数据库集成调试展示。
...
###### 5.2 工程中的4个 ETLNode 文件包工程, 除了 DetaETLNodeMedicine 用GBK, 其他三个 统一用UTF8, 已经矫正. 罗瑶光 20210413
...
###### 华瑞集35, 42 CN TMZC00000039183063ZCSQ01, CN 39183063-TMZC39183063ZCSL01 (中华人民共和国 国家知识产权局)。
###### 养疗经35, 9 CN TMZC00000039193470ZCSQ01, CN 39193470-TMZC39193470ZCSL01 (中华人民共和国 国家知识产权局)。
...
###### (中华人民共和国 国家版权局).软著登字第3951366号 德塔自然语言图灵系统研发 作者CN: 2019SR0530609  
###### 见工程文件夹: DetaParserWordSegment, DetaParserNeroMap, DetaParserSensingMap, DetaParserBehaviorMap, DetaParserEmotionMap
###### (中华人民共和国 国家版权局).软著登字第4240558号 ETL数据流处理软件研发引擎 作者CN: 2019R11L803285 
...
###  著作权申明:
###### 上述著作权 因 <德塔自然语言图灵系统> 和 <德塔Java数据分析算法> 是作者2019年 早期 第一次和国家知识产权局代理申请, 
###### 不清楚 已发表和未发表的明确法律意思, 根据字面理解为 申请著作权当天的就是已发表. 于是填写了 已发表.
###### 本人开始重新申请改为未发表. 如果国际任何机构和个人因为这两个作品引用 产生司法纠纷, 请及时联系本人 电话及微信, 并拨打法院, 司法 公安等执法热线.
###### 上述的 9个软著子作品 和 DNA思想论著 依旧使用Apache 2.0 协议 开源, 如果 国际任何机构和个人 在申请著作权受到第三方干扰, 请及时联系本人 并 司法报案维权.

### 当前华瑞集研究任务（如果有开源爱好者可自行开分支，注意协议为 GPL，避免法律纠纷）
##### 整体著作权版本组件优化和肽计算优化
###### 函数名开始整体优化
###### 重要函数开始详细注释描述
###### 配置文件综合
...
### 感谢：
###### 中国 人民教育出版社 作者的九年义务教育采用该出版社教材
###### 中国 新华字典 作者的语文文字基础来源该书籍
###### 中国 九年义务教育 作者享受了该教育政策
###### 中国 总参解放军炮兵学院南京分院 作者在此 接受了四年全日制湖北省委培本科学历教育, 获得普通高等工学学士学位
###### 印度 班加罗尔大学瑞拉理工学院, 基督学院 作者在此 接受了两年全日制 AICTE POST GRADUATE 研究生学历教育
###### 美国 加州路德大学 作者在此 接受了两年全日制 WASC POST GRADUATE 研究生学历教育 获得WASC理学荣誉硕士学位
###### 中国 卫健委 人民卫生出版社 作者的西医部分医学资料 用来大数据测试分析 来自该出版社书籍(豆丁 百度文库上购买)
###### 硬件研发设备与软件系统: ECLIPSE, GRADLE, GITHUB, GITEE, WECHAT, 联想。
