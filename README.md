...
###### 2.2 注意 数据库的row文件夹下面ID项目 sample数据 缺失, DMA 计算环境请 自己补充0,1,2 来标识.
...
###### 新华字典 作者的语文文字基础来源该书籍
###### 九年义务教育 作者享受了该教育政策
###### 总参解放军炮兵学院南京分院 作者在此 接受了全日制湖北省委培本科学历教育, 获得工学学士学位
###### 班加罗尔大学基督学院 作者在此 接受了全日制 AICTE POST GRADUATE 研究生学历教育
###### 加州路德大学 作者在此 获得全日制 WASC 理学荣誉硕士学位
###### 卫健委 人民卫生出版社 作者的西医部分医学资料 用来大数据测试分析 来自该出版社书籍(豆丁 百度文库上购买)
...
###### LGPL CMU 语音识别 DEMO(源码仅引用未修改)
###### GPL Weka 训练(源码仅引用未修改)
###### GPL Japps ffmpeg 与 JavaCV 视频中图片提取(源码仅引用未修改)
###### EPL Junit 测试组件 (源码仅引用未修改)
###### BSD JDK原生组件等(源码仅引用未修改)
###### APACHE 功能节点引用如POI, JFREECHAT等 略.
