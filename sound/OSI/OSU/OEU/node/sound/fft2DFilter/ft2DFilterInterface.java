package OSI.OSU.OEU.node.sound.fft2DFilter;
import java.awt.*;
...
{	
	...
	public void MEI_MSU(JTextPane jTextPane) throws IOException
	{
		...
		SQ_OSU_MSQ_OSU_AVQ_ASQ_AOI_AOD_AOU_AOQ_VES=new ft2DFilterPanel((ft2DFilterRun) SQ_OSU_MSQ_OSU_AVQ_ASQ_OPE_OPC_ECI);
		SQ_OSU_MSQ_OSU_AVQ_ASQ_AOI_AOD_AOU_AOQ_VES.config();
		showed=false;
	}
	public void OPE_E(JTextPane jTextPane)  throws FileNotFoundException, IOException, UnsupportedAudioFileException
	{
		((ft2DFilterRun) SQ_OSU_MSQ_OSU_AVQ_ASQ_OPE_OPC_ECI).run((ft2DFilterView) SQ_OSU_MSQ_OSU_AVQ_ASQ_AVQ_ASQ_OVQ_OSQ_VSQ);
	}
