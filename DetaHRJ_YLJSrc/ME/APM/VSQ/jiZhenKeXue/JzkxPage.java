package ME.APM.VSQ.jiZhenKeXue;
...
//import ME.sample.jzkxPage.dictionary;
import OVQ.OSU.sort.Quick9DLYGWithStringSwap;
public class JzkxPage extends Container implements MouseListener, KeyListener{
	...
	protected int row;
	public JzkxPage(JTextPane text,Analyzer analyzer, Map<String, String> pos, Map<String, String> pose
