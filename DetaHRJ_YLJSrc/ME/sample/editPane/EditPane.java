...
public class EditPane extends Container implements MouseListener, KeyListener{
	...
	private void addArabicButton() {
		comp.detaButton.DetaButton button= new comp.detaButton.DetaButton("阿语");
					...
					while(iterator.hasNext()) {
						...
						if (!setOfi.equals("")) {
							...
							if(pos.get(setOfi).contains("名")) {
								page.append("<span style=\"background:"+ new PEU.imageProcessorYLJ.ColorProcessor().Processor(255, 245, 255)
										+"\"><font color=\"black\" size=\"5\">"  + setOfi + split +
										 (ctk.containsKey(setOfi)? ctk.get(setOfi): "")+splite  +  "</font></span>");
								continue Here;
							}
							if(pos.get(setOfi).contains("动")) {
								page.append("<span style=\"background:"+new PEU.imageProcessorYLJ.ColorProcessor().Processor(245, 255, 245)+
										"\"><font color=\"black\" size=\"5\">" + setOfi + split +
										 (ctk.containsKey(setOfi)? ctk.get(setOfi):"")+splite  + "</font></span>");
								continue Here;
							}
							if(pos.get(setOfi).contains("形")) {
								page.append("<span style=\"background:"+new PEU.imageProcessorYLJ.ColorProcessor().Processor(255, 255, 245)
										+ "\"><font color=\"black\" size=\"5\">" + setOfi + split +
										 (ctk.containsKey(setOfi)? ctk.get(setOfi):"") + splite + "</font></span>");
								continue Here;
							}
	...
	private void addRussianButton() {
		comp.detaButton.DetaButton button= new comp.detaButton.DetaButton("俄语");
				...
				Here:
					while(iterator.hasNext()) {
						...
						if (!setOfi.equals("")) {
							...
							if(pos.get(setOfi).contains("名")) {
								page.append("<span style=\"background:"+new PEU.imageProcessorYLJ.ColorProcessor().Processor(255, 245, 255)+"\"><font color=\"black\" size=\"5\">"  + setOfi +split+
										 (ctr.containsKey(setOfi)? ctr.get(setOfi):"")+splite  +  "</font></span>");
								continue Here;
							}
							if(pos.get(setOfi).contains("动")) {
	...
	private void addTranditionButton() {
		comp.detaButton.DetaButton button= new comp.detaButton.DetaButton("繁体");
	...
	private void addJapanButton() {
		comp.detaButton.DetaButton button= new comp.detaButton.DetaButton("日语");
	...
	private void addPinYinButton() {
		comp.detaButton.DetaButton button= new comp.detaButton.DetaButton("拼音");
				...
				Here:
					while(iterator.hasNext()) {
						...
						if (!setOfi.equals("")) {
							...
							if(pos.get(setOfi).contains("名")) {
								page.append("<span style=\"background:"+new PEU.imageProcessorYLJ.ColorProcessor().Processor(255, 245, 255)+"\"><font color=\"black\" size=\"5\">"  + setOfi +
										 (pinyin.containsKey(setOfi)? pinyin.get(setOfi):"") +  "</font></span>");
								continue Here;
							}
							if(pos.get(setOfi).contains("动")) {
								page.append("<span style=\"background:"+new PEU.imageProcessorYLJ.ColorProcessor().Processor(245, 255, 245)+"\"><font color=\"black\" size=\"5\">" + setOfi +
										 (pinyin.containsKey(setOfi)? pinyin.get(setOfi):"") + "</font></span>");
								continue Here;
							}
							if(pos.get(setOfi).contains("形")) {
								page.append("<span style=\"background:"+new PEU.imageProcessorYLJ.ColorProcessor().Processor(255, 255, 245)+"\"><font color=\"black\" size=\"5\">" + setOfi +
										 (pinyin.containsKey(setOfi)? pinyin.get(setOfi):"") + "</font></span>");
								continue Here;
							}
							if(pos.get(setOfi).contains("副")) {
	...
	private void addReadButton() {
		comp.detaButton.DetaButton button= new comp.detaButton.DetaButton("阅读");
				...
				Here:
					while(iterator.hasNext()) {
						...
						if (!setOfi.equals("")) {
							...
							if(pos.get(setOfi).contains("名")) {
								page.append("<span style=\"background:"+new PEU.imageProcessorYLJ.ColorProcessor().Processor(255, 245, 255)+"\"><font color=\"black\" size=\"5\">" + setOfi +(cte.containsKey(setOfi)?":("+cte.get(setOfi)+")":"") + "</font></span>");
								continue Here;
							}
							if(pos.get(setOfi).contains("动")) {
								page.append("<span style=\"background:"+new PEU.imageProcessorYLJ.ColorProcessor().Processor(245, 255, 245)+"\"><font color=\"black\" size=\"5\">" + setOfi +(cte.containsKey(setOfi)?":("+cte.get(setOfi)+")":"") + "</font></span>");
								continue Here;
							}
							if(pos.get(setOfi).contains("形")) {
								page.append("<span style=\"background:"+new PEU.imageProcessorYLJ.ColorProcessor().Processor(255, 255, 245)+"\"><font color=\"black\" size=\"5\">" + setOfi +(cte.containsKey(setOfi)?":("+cte.get(setOfi)+")":"") + "</font></span>");
								continue Here;
							}
							if(pos.get(setOfi).contains("副")) {
				...
				Here:
					while(iterator.hasNext()) {
						...
						if (!setOfi.equals("")) {
							...
							if(pos.get(setOfi).contains("动")) {
								page.append("<span style=\"background:"+new PEU.imageProcessorYLJ.ColorProcessor().Processor(145, 255, 145)+"\"><font color=\"black\" size=\"5\">" + setOfi + "</font></span>");
								continue Here;
							}
							if(pos.get(setOfi).contains("形")) {
								page.append("<span style=\"background:"+new PEU.imageProcessorYLJ.ColorProcessor().Processor(255, 255, 145)+"\"><font color=\"black\" size=\"5\">" + setOfi + "</font></span>");
								continue Here;
							}
							if(pos.get(setOfi).contains("副")) {
