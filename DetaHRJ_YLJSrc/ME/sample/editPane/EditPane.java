...
public class EditPane extends Container implements MouseListener, KeyListener{
	...
	private void addArabicButton() {
		MVQ.detaButton.DetaButton button= new MVQ.detaButton.DetaButton("阿语");
	...
	private void addRussianButton() {
		MVQ.detaButton.DetaButton button= new MVQ.detaButton.DetaButton("俄语");
	...
	private void addTranditionButton() {
		MVQ.detaButton.DetaButton button= new MVQ.detaButton.DetaButton("繁体");
	...
	private void addJapanButton() {
		MVQ.detaButton.DetaButton button= new MVQ.detaButton.DetaButton("日语");
	...
	private void addPinYinButton() {
		MVQ.detaButton.DetaButton button= new MVQ.detaButton.DetaButton("拼音");
	...
	private void addReadButton() {
		MVQ.detaButton.DetaButton button= new MVQ.detaButton.DetaButton("阅读");
