...
, ActionListener, MouseMotionListener{
	...
	private void addFifthColomns(JTextField 诊断结果_box, List<DetaLabel> jFrameList) {
		...
		//copy tab
		DetaLabel 疥疮镜检sarcoptes= new DetaLabel("血渗透压血osm:");  
		疥疮镜检sarcoptes.setForeground(Color.WHITE);
		疥疮镜检sarcoptes.setBounds(10+220*4, 32+ 0, 100, 20);jFrameList.add(疥疮镜检sarcoptes);
		
		JTextField 疥疮镜检sarcoptes_box= new JTextField();
		疥疮镜检sarcoptes_box.setBounds(10+ 110+220*4, 33+ 0, 80, 20);
		疥疮镜检sarcoptes_box.addActionListener(new ActionListener(){
			@Override
			public void actionPerformed(ActionEvent arg0) {
				//加状态；
				String temp= 疥疮镜检sarcoptes_box.getText();
				double temp_double= Double.valueOf(temp);
		...
		DetaLabel 胰岛素ins= new DetaLabel("肌酐清除率cor:");  
		胰岛素ins.setForeground(Color.WHITE);
		胰岛素ins.setBounds(10+220*4, 32+ 25*1, 100, 20);jFrameList.add(胰岛素ins);
		
		JTextField 胰岛素ins_box= new JTextField();
		胰岛素ins_box.setBounds(10+ 110+220*4, 33+ 25*1, 80, 20);
		胰岛素ins_box.addActionListener(new ActionListener(){
			@Override
			public void actionPerformed(ActionEvent arg0) {
				//加状态；
				String temp= 胰岛素ins_box.getText();
				double temp_double= Double.valueOf(temp);
	...
	private void addThirdColomns(JTextField 诊断结果_box, List<DetaLabel> jFrameList) {
		...
		DetaLabel 胰岛素ins= new DetaLabel("白色念珠菌抗体:");  
		胰岛素ins.setForeground(Color.WHITE);
		胰岛素ins.setBounds(10+220*2, 32+ 25*1, 100, 20);jFrameList.add(胰岛素ins);
		JTextField 胰岛素ins_box= new JTextField();
		胰岛素ins_box.setBounds(10+ 110+220*2, 33+ 25*1, 80, 20);
		胰岛素ins_box.addActionListener(new ActionListener(){
			@Override
			public void actionPerformed(ActionEvent arg0) {
				//加状态；
