...
, ActionListener, MouseMotionListener{
	...
	public LinChuangJianYanBaoGaoA(JTextPane name, List<DetaLabel> jFrameListRefer){
		...
		DetaIndexLabel 索引b= new DetaIndexLabel(" B ");  
		索引b.setForeground(Color.WHITE);
		索引b.setBounds(10+ 25*2, 1, 1000, 25);  
		索引b.setIndex("B");
		this.add(索引b);
		
		DetaIndexLabel 索引c= new DetaIndexLabel(" C ");  
		索引c.setForeground(Color.WHITE);
		索引c.setBounds(10+ 25*3, 1, 1000, 25);  
		索引c.setIndex("C");
		this.add(索引c);
		
		DetaIndexLabel 索引d= new DetaIndexLabel(" D");  
		索引d.setForeground(Color.WHITE);
		索引d.setBounds(10+ 25*4, 1, 1000, 25);  
		索引d.setIndex("D");
		this.add(索引d);
		
		DetaIndexLabel 索引e= new DetaIndexLabel(" E ");  
		索引e.setForeground(Color.WHITE);
		索引e.setBounds(10+ 25*5, 1, 1000, 25);  
		索引e.setIndex("E");
		this.add(索引e);
		
		DetaIndexLabel 索引f= new DetaIndexLabel(" F ");  
		索引f.setForeground(Color.WHITE);
		索引f.setBounds(10+ 25*6, 1, 1000, 25);  
		索引f.setIndex("F");
		this.add(索引f);
		
		DetaIndexLabel 索引g= new DetaIndexLabel(" G ");  
		索引g.setForeground(Color.WHITE);
		索引g.setBounds(10+ 25*7, 1, 1000, 25);  
		索引g.setIndex("G");
		this.add(索引g);
		
		DetaIndexLabel 索引h= new DetaIndexLabel(" H ");  
		索引h.setForeground(Color.WHITE);
		索引h.setBounds(10+ 25*8, 1, 1000, 25);  
		索引h.setIndex("H");
		this.add(索引h);
		
		DetaIndexLabel 索引i= new DetaIndexLabel(" I ");  
		索引i.setForeground(Color.WHITE);
		索引i.setBounds(10+ 25*9, 1, 1000, 25);  
		索引i.setIndex("I");
		this.add(索引i);
		
		DetaIndexLabel 索引j= new DetaIndexLabel(" J ");  
		索引j.setForeground(Color.WHITE);
		索引j.setBounds(10+ 25*10, 1, 1000, 25);  
		索引j.setIndex("J");
		this.add(索引j);
		
		DetaIndexLabel 索引k= new DetaIndexLabel(" K ");  
		索引k.setForeground(Color.WHITE);
		索引k.setBounds(10+ 25*11, 1, 1000, 25);  
		索引k.setIndex("K");
		this.add(索引k);
		
		DetaIndexLabel 索引l= new DetaIndexLabel(" L ");  
		索引l.setForeground(Color.WHITE);
		索引l.setBounds(10+ 25*12, 1, 1000, 25);  
		索引l.setIndex("L");
		this.add(索引l);
		
		DetaIndexLabel 索引m= new DetaIndexLabel(" M ");  
		索引m.setForeground(Color.WHITE);
		索引m.setBounds(10+ 25*13, 1, 1000, 25);  
		索引m.setIndex("M");
		this.add(索引m);
		
		DetaIndexLabel 索引n= new DetaIndexLabel(" N ");  
		索引n.setForeground(Color.WHITE);
		索引n.setBounds(10+ 25*14, 1, 1000, 25);  
		索引n.setIndex("N");
		this.add(索引n);
		
		DetaIndexLabel 索引o= new DetaIndexLabel(" O ");  
		索引o.setForeground(Color.WHITE);
		索引o.setBounds(10+ 25*15, 1, 1000, 25);  
		索引o.setIndex("O");
		this.add(索引o);
		
		DetaIndexLabel 索引p= new DetaIndexLabel(" P ");  
		索引p.setForeground(Color.WHITE);
		索引p.setBounds(10+ 25*16, 1, 1000, 25);  
		索引p.setIndex("P");
		this.add(索引p);
		
		DetaIndexLabel 索引q= new DetaIndexLabel(" Q ");  
		索引q.setForeground(Color.WHITE);
		索引q.setBounds(10+ 25*17, 1, 1000, 25);  
		索引q.setIndex("Q");
		this.add(索引q);
		
		DetaIndexLabel 索引r= new DetaIndexLabel(" R ");  
		索引r.setForeground(Color.WHITE);
		索引r.setBounds(10+ 25*18, 1, 1000, 25);  
		索引r.setIndex("R");
		this.add(索引r);
		
		DetaIndexLabel 索引s= new DetaIndexLabel(" S ");  
		索引s.setForeground(Color.WHITE);
		索引s.setBounds(10+ 25*19, 1, 1000, 25);  
		索引s.setIndex("S");
		this.add(索引s);
		
		DetaIndexLabel 索引t= new DetaIndexLabel(" T ");  
		索引t.setForeground(Color.WHITE);
		索引t.setBounds(10+ 25*20, 1, 1000, 25);  
		索引t.setIndex("T");
		this.add(索引t);
		
		DetaIndexLabel 索引u= new DetaIndexLabel(" U ");  
		索引u.setForeground(Color.WHITE);
		索引u.setBounds(10+ 25*21, 1, 1000, 25);  
		索引u.setIndex("U");
		this.add(索引u);
		
		DetaIndexLabel 索引v= new DetaIndexLabel(" V ");  
		索引v.setForeground(Color.WHITE);
		索引v.setBounds(10+ 25*22, 1, 1000, 25);  
		索引v.setIndex("V");
		this.add(索引v);
		
		DetaIndexLabel 索引w= new DetaIndexLabel(" W ");  
		索引w.setForeground(Color.WHITE);
		索引w.setBounds(10+ 25*23, 1, 1000, 25);  
		索引w.setIndex("W");
		this.add(索引w);
		
		DetaIndexLabel 索引x= new DetaIndexLabel(" X ");  
		索引x.setForeground(Color.WHITE);
		索引x.setBounds(10+ 25*24, 1, 1000, 25);  
		索引x.setIndex("X");
		this.add(索引x);
		
		DetaIndexLabel 索引y= new DetaIndexLabel(" Y ");  
		索引y.setForeground(Color.WHITE);
		索引y.setBounds(10+ 25*25, 1, 1000, 25);  
		索引y.setIndex("Y");
		this.add(索引y);
		
		DetaIndexLabel 索引z= new DetaIndexLabel(" Z ");  
		索引z.setForeground(Color.WHITE);
		索引z.setBounds(10+ 25*26, 1, 1000, 25);  
		索引z.setIndex("Z");
		this.add(索引z);
