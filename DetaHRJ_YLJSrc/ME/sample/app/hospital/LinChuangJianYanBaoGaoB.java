...
public class LinChuangJianYanBaoGaoB  extends JPanel implements MouseListener, KeyListener, ActionListener, MouseMotionListener{
	...
	public LinChuangJianYanBaoGaoB(JTextPane name, App app, List<DetaLabel> jFrameListRefer){
		...
		索引a.setBounds(10+ 25*1, 1, 25, 25);  
		索引a.setIndex("A");
		this.add(索引a);
		
		DetaIndexLabel 索引b= new DetaIndexLabel(" B ", jFrameList);    
		索引b.setForeground(Color.WHITE);
		索引b.setBounds(10+ 25*2, 1, 25, 25);  
		索引b.setIndex("B");
		this.add(索引b);
		
		DetaIndexLabel 索引c= new DetaIndexLabel(" C ", jFrameList);  
		索引c.setForeground(Color.WHITE);
		索引c.setBounds(10+ 25*3, 1, 25, 25);  
		索引c.setIndex("C");
		this.add(索引c);
		
		DetaIndexLabel 索引d= new DetaIndexLabel(" D", jFrameList);    
		索引d.setForeground(Color.WHITE);
		索引d.setBounds(10+ 25*4, 1, 25, 25);  
		索引d.setIndex("D");
		this.add(索引d);
		
		DetaIndexLabel 索引e= new DetaIndexLabel(" E ", jFrameList);  
		索引e.setForeground(Color.WHITE);
		索引e.setBounds(10+ 25*5, 1, 25, 25);  
		索引e.setIndex("E");
		this.add(索引e);
		
		DetaIndexLabel 索引f= new DetaIndexLabel(" F ", jFrameList);   
		索引f.setForeground(Color.WHITE);
		索引f.setBounds(10+ 25*6, 1, 25, 25);  
		索引f.setIndex("F");
		this.add(索引f);
		
		DetaIndexLabel 索引g= new DetaIndexLabel(" G ", jFrameList);   
		索引g.setForeground(Color.WHITE);
		索引g.setBounds(10+ 25*7, 1, 25, 25);  
		索引g.setIndex("G");
		this.add(索引g);
		
		DetaIndexLabel 索引h= new DetaIndexLabel(" H ", jFrameList);   
		索引h.setForeground(Color.WHITE);
		索引h.setBounds(10+ 25*8, 1, 25, 25);  
		索引h.setIndex("H");
		this.add(索引h);
		
		DetaIndexLabel 索引i= new DetaIndexLabel(" I ", jFrameList);   
		索引i.setForeground(Color.WHITE);
		索引i.setBounds(10+ 25*9, 1, 25, 25);  
		索引i.setIndex("I");
		this.add(索引i);
		
		DetaIndexLabel 索引j= new DetaIndexLabel(" J ", jFrameList);   
		索引j.setForeground(Color.WHITE);
		索引j.setBounds(10+ 25*10, 1, 25, 25);  
		索引j.setIndex("J");
		this.add(索引j);
		
		DetaIndexLabel 索引k= new DetaIndexLabel(" K ", jFrameList);  
		索引k.setForeground(Color.WHITE);
		索引k.setBounds(10+ 25*11, 1, 25, 25);  
		索引k.setIndex("K");
		this.add(索引k);
		
		DetaIndexLabel 索引l= new DetaIndexLabel(" L ", jFrameList);   
		索引l.setForeground(Color.WHITE);
		索引l.setBounds(10+ 25*12, 1, 25, 25);  
		索引l.setIndex("L");
		this.add(索引l);
		
		DetaIndexLabel 索引m= new DetaIndexLabel(" M ", jFrameList);  
		索引m.setForeground(Color.WHITE);
		索引m.setBounds(10+ 25*13, 1, 25, 25);  
		索引m.setIndex("M");
		this.add(索引m);
		
		DetaIndexLabel 索引n= new DetaIndexLabel(" N ", jFrameList);  
		索引n.setForeground(Color.WHITE);
		索引n.setBounds(10+ 25*14, 1, 25, 25);  
		索引n.setIndex("N");
		this.add(索引n);
		
		DetaIndexLabel 索引o= new DetaIndexLabel(" O ", jFrameList);    
		索引o.setForeground(Color.WHITE);
		索引o.setBounds(10+ 25*15, 1, 25, 25);  
		索引o.setIndex("O");
		this.add(索引o);
		
		DetaIndexLabel 索引p= new DetaIndexLabel(" P ", jFrameList);  
		索引p.setForeground(Color.WHITE);
		索引p.setBounds(10+ 25*16, 1, 25, 25);  
		索引p.setIndex("P");
		this.add(索引p);
		
		DetaIndexLabel 索引q= new DetaIndexLabel(" Q ", jFrameList);   
		索引q.setForeground(Color.WHITE);
		索引q.setBounds(10+ 25*17, 1, 25, 25);  
		索引q.setIndex("Q");
		this.add(索引q);
		
		DetaIndexLabel 索引r= new DetaIndexLabel(" R ", jFrameList);   
		索引r.setForeground(Color.WHITE);
		索引r.setBounds(10+ 25*18, 1, 25, 25);  
		索引r.setIndex("R");
		this.add(索引r);
		
		DetaIndexLabel 索引s= new DetaIndexLabel(" S ", jFrameList);  
		索引s.setForeground(Color.WHITE);
		索引s.setBounds(10+ 25*19, 1, 25, 25);  
		索引s.setIndex("S");
		this.add(索引s);
		
		DetaIndexLabel 索引t= new DetaIndexLabel(" T ", jFrameList);   
		索引t.setForeground(Color.WHITE);
		索引t.setBounds(10+ 25*20, 1, 25, 25);  
		索引t.setIndex("T");
		this.add(索引t);
		
		DetaIndexLabel 索引u= new DetaIndexLabel(" U ", jFrameList);   
		索引u.setForeground(Color.WHITE);
		索引u.setBounds(10+ 25*21, 1, 25, 25);  
		索引u.setIndex("U");
		this.add(索引u);
		
		DetaIndexLabel 索引v= new DetaIndexLabel(" V ", jFrameList);   
		索引v.setForeground(Color.WHITE);
		索引v.setBounds(10+ 25*22, 1, 25, 25);  
		索引v.setIndex("V");
		this.add(索引v);
		
		DetaIndexLabel 索引w= new DetaIndexLabel(" W ", jFrameList);   
		索引w.setForeground(Color.WHITE);
		索引w.setBounds(10+ 25*23, 1, 25, 25);  
		索引w.setIndex("W");
		this.add(索引w);
		
		DetaIndexLabel 索引x= new DetaIndexLabel(" X ", jFrameList);   
		索引x.setForeground(Color.WHITE);
		索引x.setBounds(10+ 25*24, 1, 25, 25);  
		索引x.setIndex("X");
		this.add(索引x);
		
		DetaIndexLabel 索引y= new DetaIndexLabel(" Y ", jFrameList);  
		索引y.setForeground(Color.WHITE);
		索引y.setBounds(10+ 25*25, 1, 25, 25);  
		索引y.setIndex("Y");
		this.add(索引y);
		
		DetaIndexLabel 索引z= new DetaIndexLabel(" Z ", jFrameList);   
		索引z.setForeground(Color.WHITE);
		索引z.setBounds(10+ 25*26, 1, 25, 25);  
		索引z.setIndex("Z");
		this.add(索引z);
		...
		弓形体igm.setBounds(10+220*0, 32+ 25*10, 100, 20);jFrameList.add(弓形体igm);
		...
		载脂蛋白ap0bap0b.setBounds(10+220*0, 32+ 25*11, 100, 20);jFrameList.add(载脂蛋白ap0bap0b);
		...
		尿酸uric.setBounds(10+220*0, 32+ 25*12, 100, 20);jFrameList.add(尿酸uric);
		...
		胰高糖素.setBounds(10+220*0, 32+ 25*13, 100, 20);jFrameList.add(胰高糖素);
	...
	private void addFifthColomns(JTextField 诊断结果_box2, List<DetaLabel> jFrameList) {
		...
		军团菌抗原检测.setBounds(10+220*1, 32+ 0, 100, 20);jFrameList.add(军团菌抗原检测);
		...
		真菌培养取材.setBounds(10+220*1, 32+ 25*1, 100, 20);jFrameList.add(真菌培养取材);
		...
		转肽酶ggt.setBounds(10+220*1, 32+ 25*2, 100, 20);jFrameList.add(转肽酶ggt);
		...
		免疫组化验查.setBounds(10+220*1, 32+ 25* 3, 100, 20);jFrameList.add(免疫组化验查);
		...
		四项诱导血小板聚集功能.setBounds(10+220*1, 32+ 25*4, 100, 20);jFrameList.add(四项诱导血小板聚集功能);
		...
		髓鞘碱性蛋白.setBounds(10+220*1, 32+ 25*5, 100, 20);jFrameList.add(髓鞘碱性蛋白);
		...
		皮肤病理活检.setBounds(10+220*1, 32+ 25*6, 100, 20);jFrameList.add(皮肤病理活检);
		...
		血尿锌.setBounds(10+220*1, 32+ 25*7, 100, 20);jFrameList.add(血尿锌);
		...
		尿皮质醇尿皮质醇.setBounds(10+220*1, 32+ 25*8, 100, 20);jFrameList.add(尿皮质醇尿皮质醇);
		...
		白色念珠菌抗原.setBounds(10+220*1, 32+ 25*9, 100, 20);jFrameList.add(白色念珠菌抗原);
		...
		乙肝两对半hbeab.setBounds(10+220*1, 32+ 25*10, 100, 20);jFrameList.add(乙肝两对半hbeab);
		...
		早老素.setBounds(10+220*1, 32+ 25*11, 100, 20);jFrameList.add(早老素);
		...
		总蛋白tp.setBounds(10+220*1, 32+ 25*12, 100, 20);jFrameList.add(总蛋白tp);
		...
		肺炎支原体igg.setBounds(10+220*1, 32+ 25*13, 100, 20);jFrameList.add(肺炎支原体igg);
	...
	void addFourthColomns(JTextField 诊断结果_box2, List<DetaLabel> jFrameList) {
		...
		淋球菌培养取材.setBounds(10+220*2, 32+ 0, 100, 20);jFrameList.add(淋球菌培养取材);
		...
		尿酸尿.setBounds(10+220*2, 32+ 25*1, 100, 20);jFrameList.add(尿酸尿);
		...
		血小板聚集.setBounds(10+220*2, 32+ 25*2, 100, 20);jFrameList.add(血小板聚集);
	...
	private void addThirdColomns(JTextField 诊断结果_box2, List<DetaLabel> jFrameList) {
		...
		促进泡生成素fsm.setBounds(10+220*3, 32+ 25*8, 100, 20);jFrameList.add(促进泡生成素fsm);
		...
		d二聚体.setBounds(10+220*3, 32+ 25*9, 100, 20);jFrameList.add(d二聚体);
		...
		间接胆红质.setBounds(10+220*3, 32+ 25*10, 100, 20);jFrameList.add(间接胆红质);
		...
		t细胞亚群测定.setBounds(10+220*3, 32+ 25*11, 100, 20);jFrameList.add(t细胞亚群测定);
	...
	private void addSecondColomns(JTextField 诊断结果_box2, List<DetaLabel> jFrameList) {
		...
		羟丁酸脱氢酶.setBounds(10+220*4, 32+ 25*4, 100, 20);jFrameList.add(羟丁酸脱氢酶);
		...
		肽c.setBounds(10+220*4, 32+ 25*5, 100, 20);jFrameList.add(肽c);
		...
		性病衣原体快速检测.setBounds(10+220*4, 32+ 25*6, 100, 20);jFrameList.add(性病衣原体快速检测);
		...
		催孔素.setBounds(10+220*4, 32+ 25*7, 100, 20);jFrameList.add(催孔素);
		...
		骨髓巨核细胞定量.setBounds(10+220*4, 32+ 25*8, 100, 20);jFrameList.add(骨髓巨核细胞定量);
		...
		血气分析加离子分析.setBounds(10+220*4, 32+ 25*9, 100, 20);jFrameList.add(血气分析加离子分析);
		...
		脑脊液生化糖.setBounds(10+220*4, 32+ 25*10, 100, 20);jFrameList.add(脑脊液生化糖);
		...
		血管紧张素转化酶.setBounds(10+220*4, 32+ 25*11, 100, 20);jFrameList.add(血管紧张素转化酶);
		...
		糖元染色.setBounds(10+220*4, 32+ 25*12, 100, 20);jFrameList.add(糖元染色);
		...
		脑脊液细胞学检查.setBounds(10+220*4, 32+ 25*13, 100, 20);jFrameList.add(脑脊液细胞学检查);
