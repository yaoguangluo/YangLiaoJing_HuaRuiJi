...
public class MakeContainerZYWS extends Thread implements Runnable{
	...
	public MakeContainerZYWS(Analyzer analyzer, App u2, JTabbedPane jTabbedpane
	...
	public void run(){ 
		try {
			...
			Thread.sleep(1000*1);
			u.wskx = new WskxPage(u.text, this.analyzer,pos, pose, etc, cte, u, jTabbedpane);
			u.wskx.setName(tabNames.get(13));
			jTabbedpane.addTab(tabNames.get(13),new ImageIcon() , u.wskx, "中医外伤科学");// 加入第一个页面  
