...
public class MakeContainerXYWK extends Thread implements Runnable{
	...
	public MakeContainerXYWK(Analyzer analyzer, App u2, JTabbedPane jTabbedpane, List<String> tabNames2,Map<String, String> pos, Map<String, String> pose, Map<String, String> etc, Map<String, String> cte) {
		super();
		this.u = u2;
