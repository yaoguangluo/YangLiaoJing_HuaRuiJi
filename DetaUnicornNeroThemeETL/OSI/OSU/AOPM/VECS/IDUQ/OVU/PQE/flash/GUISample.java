...
import OSI.OSU.MSI.OEI.SOI.SMQ.save.SaveAndUpdateFile;
...
import OSI.OSU.OVU.MVQ.OVU.PQE.nodeView.CacuString;
				...
				while(node!= null){
					if(node.name.equals(canvas.currentNodeName)&&node.ID== canvas.currentNodeID
						...
						try {
							...
							new OSI.OSU.SI.MCI.OEI.OVU.PQE.extOSGI.OSGI_chansfer(node, first.first);
						} catch (IOException e1){
