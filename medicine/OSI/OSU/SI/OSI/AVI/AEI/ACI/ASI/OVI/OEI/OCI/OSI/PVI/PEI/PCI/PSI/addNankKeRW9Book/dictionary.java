...
public class dictionary{	
	...
	public Map<String, Object> listToMap(Map<String, Object> dic_input_map, List<String> dic_list) throws IOException{
		...
		for(int i= 0; i< dic_list.size(); i++) {
			if(dic_list.get(i).contains("病症段落")) {
				...
				dic_input_map.put(med_name.replaceAll("\\s*", "").replace("〔","").replace("〕",":"), (med_text+"〔〔").replace("\\s+", " "));
			}
		}
