package OSI.OSU.ASQ.tinos.deta.tsp;
...
public class YaoguangLuoEulerRingTSP{
	...
	public List<Line2D> getYaoguangLuo2DEulerRingTSP(List<Position2D> AMV_MVS_VSQs){
		//1 annotations
	...
	public List<Line3D> getYaoguangLuo3DEulerRingTSP(List<Position3D> AMV_MVS_VSQs){
		//1 annotations
