...
public class PDE_Increment_FullFormular {
	...
	public Initon PDE_IncrementE_DU(InitonLinkDNA initonLinkDNA, FullTokenPDI pDE_RNA_Formular, boolean bYS) {
//		Initon initonLink= initonLinkDNA.getInitonLink();
//		//int index= 0;
//		while(null!= initonLink) {
//			String initonString= initonLink.getStore();
//			if(initonLink.getStore().equalsIgnoreCase("I")|| initonLink.getStore().equalsIgnoreCase("D")) {
//				if(initonLink.hasNext()) {
//					Initon initonNext= initonLink.forwardNext();
...
//		return initonLink;
		...
		while(null!= initonLink) {
			String initonString= initonLink.getStore();
			if(initonLink.getStore().equalsIgnoreCase("D")|| initonLink.getStore().equalsIgnoreCase("U")) {
				Initon initonIncrementE= new Initon();
	...
	public Initon PDE_IncrementS_IQ(InitonLinkDNA initonLinkDNA, FullTokenPDI pDE_RNA_Formular) {
		Initon initonLink= initonLinkDNA.getInitonLink();
		//int index= 0;
		while(null!= initonLink) {
			String initonString= initonLink.getStore();
