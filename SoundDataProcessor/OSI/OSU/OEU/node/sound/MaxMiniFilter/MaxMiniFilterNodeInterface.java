...
{	
	public MaxMiniFilterNodeInterface() throws IOException
 	{
		...
		SQ_OSU_MSQ_OSU_AVQ_ASQ_SQ_VPC_PCS=new String("ÂÞÑþ¹âFilter");
	...
	public void MEI_MSU(JTextPane jTextPane) throws IOException
	{
		...
		SQ_OSU_MSQ_OSU_AVQ_ASQ_AOI_AOD_AOU_AOQ_VES=new MaxMiniFilterOSU_MSQ_AOI_AOD_AOU_AOQ_VES((MaxMiniFilterOSU_MSQ_OPE_OPC_ECI) SQ_OSU_MSQ_OSU_AVQ_ASQ_OPE_OPC_ECI);
		SQ_OSU_MSQ_OSU_AVQ_ASQ_AOI_AOD_AOU_AOQ_VES.config();
		showed=false;
	}
	public void OPE_E(JTextPane jTextPane)  throws FileNotFoundException, IOException, UnsupportedAudioFileException
	{
		((MaxMiniFilterOSU_MSQ_OPE_OPC_ECI) SQ_OSU_MSQ_OSU_AVQ_ASQ_OPE_OPC_ECI).run((MaxMiniFilterOSU_MSQ_AVQ_ASQ_OVQ_OSQ_VSQ) SQ_OSU_MSQ_OSU_AVQ_ASQ_AVQ_ASQ_OVQ_OSQ_VSQ);
	}
