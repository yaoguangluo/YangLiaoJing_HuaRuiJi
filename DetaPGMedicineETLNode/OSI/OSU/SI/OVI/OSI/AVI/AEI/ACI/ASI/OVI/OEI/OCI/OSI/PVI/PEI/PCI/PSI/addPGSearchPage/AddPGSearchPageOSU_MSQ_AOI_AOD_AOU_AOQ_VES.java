...
public class AddPGSearchPageOSU_MSQ_AOI_AOD_AOU_AOQ_VES extends OSU_AVQ_ASQ_AOI_AOD_AOU_AOQ_VES{
	private static final long serialVersionUID = 1L;
	private JTextPane textTemp;
	private Object[][] tableData_old;
	public String DNNtext;
	public AddPGSearchPageOSU_MSQ_AOI_AOD_AOU_AOQ_VES(final AddPGSearchPageOSU_MSQ_OPE_OPC_ECI SQ_OSU_MSQ_OSU_AVQ_ASQ_OPE_OPC_ECI, JTextPane text
		...
		panel.add(button);
		JButton readfile= new JButton("配置DNN");
