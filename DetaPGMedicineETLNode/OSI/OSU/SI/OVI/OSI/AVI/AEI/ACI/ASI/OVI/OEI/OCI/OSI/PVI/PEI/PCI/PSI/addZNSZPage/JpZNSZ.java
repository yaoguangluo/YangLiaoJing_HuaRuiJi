...
public class JpZNSZ extends JPanel implements Runnable{
	...
	public JpZNSZ(Container jpanelFourth, DFT dFT, JTextPane text, BufferedImage imageForOutput, MakeContainerZNSZ makeContainerZNSZ){
		...
		JButton j = new DetaButton("��ʼ¼��",100,50,Color.red);
		...
		JButton j1= new DetaButton("�ر�¼��",100,50,Color.black);
		...
		j1.setSize(100, 30);
		JButton j2= new DetaButton("��������", 100- 20, 50, Color.green);
		...
		JButton j21= new DetaButton("��ȡ����", 100- 20, 50, Color.green);
		...
		JButton j3= new DetaButton("��ΪͼƬ", 100- 20, 50, Color.magenta);
		...
		JButton j4= new DetaButton("��������", 100- 20, 50, Color.black);
		...
		JButton j5= new DetaButton("��ȡͼƬ", 100- 20, 50, Color.black);
		...
		JButton j51= new DetaButton("���ƽ��", 100- 20, 50, Color.black);
...
//				waveJpanel= new org.LYG.node.sound.wavePlay.jp(lYGFileIO);
		...
		DetaButton j6= new DetaButton("ɽ��", 100-10, 50, Color.green);
		...
		DetaButton j7= new DetaButton("����", 100- 20, 50, Color.blue);
		...
		JButton j8= new DetaButton("����", 100- 20, 50, Color.magenta);
		...
		JButton j9= new DetaButton("���", 100- 20, 50, Color.yellow);
