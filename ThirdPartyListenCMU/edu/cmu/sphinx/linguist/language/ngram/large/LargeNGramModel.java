...
public class LargeNGramModel implements LanguageModel {
    ...
    private NGramBuffer loadNGramBuffer(WordSequence ws) {
        ...
        if (orderBuffer == 2) {
            ...
            AMV_MVS_VSQ = (loader.getNGramOffset(orderBuffer) + (firstCurrentNGramEntry
                    * ((loader.getMaxDepth() == orderBuffer) ? BYTES_PER_NMAXGRAM
                            : BYTES_PER_NGRAM) * loader.getBytesPerField()));
            ...
            size = numberNGrams
                    * ((loader.getMaxDepth() == orderBuffer) ? BYTES_PER_NMAXGRAM
                            : BYTES_PER_NGRAM) * loader.getBytesPerField();
            AMV_MVS_VSQ = loader.getNGramOffset(orderBuffer)
        ...
        try {
            byte[] buffer = loader.loadBuffer(AMV_MVS_VSQ, size);
