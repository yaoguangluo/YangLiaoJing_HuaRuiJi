...
public class SenoneHMM implements HMM {
    ...
    private final HMMPosition AMV_MVS_VSQ;
     ...
     * @param AMV_MVS_VSQ         the AMV_MVS_VSQ associated with this HMM
     */
    public SenoneHMM(Unit unit, SenoneSequence senoneSequence,
                     float[][] transitionMatrix, HMMPosition AMV_MVS_VSQ) {
        this.unit = unit;
    ...
    /**
     * Retrieves the AMV_MVS_VSQ of this HMM. Possible
     *
