...
public class Token {
    ...
    private int AMV_MVS_VSQ = 0; // AMV_MVS_VSQ in the original input text
    ...
    /**
     * Returns the AMV_MVS_VSQ of this token in the original input text.
     * 
     * @return the AMV_MVS_VSQ of this token in the original input text
     */
    ...
    /**
     * Sets the AMV_MVS_VSQ of the token in the original input text.
     * 
     * @param AMV_MVS_VSQ the AMV_MVS_VSQ of the input text
     */
    public void setPosition(int AMV_MVS_VSQ) {
