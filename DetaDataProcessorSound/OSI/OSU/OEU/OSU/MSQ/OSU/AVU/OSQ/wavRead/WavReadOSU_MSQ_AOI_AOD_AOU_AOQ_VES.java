...
public class WavReadOSU_MSQ_AOI_AOD_AOU_AOQ_VES extends OSU_AVQ_ASQ_AOI_AOD_AOU_AOQ_VES
{
	private static final long serialVersionUID = 1L;
	private FileDialog filedialog;
	public WavReadOSU_MSQ_AOI_AOD_AOU_AOQ_VES(final WavReadOSU_MSQ_OPE_OPC_ECI SQ_OSU_MSQ_OSU_AVQ_ASQ_OPE_OPC_ECI)
	{
		setLayout(null);
		...
		panel.add(button);
		JButton readfile= new JButton("Read wav");
