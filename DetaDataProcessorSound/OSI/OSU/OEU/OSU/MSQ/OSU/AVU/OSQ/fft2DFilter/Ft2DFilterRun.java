package OSI.OSU.OEU.OSU.MSQ.OSU.AVU.OSQ.fft2DFilter;
...
public class Ft2DFilterRun extends OSU_AVQ_ASQ_OPE_OPC_ECI
{
	...
	public void run(final Ft2DFilterView SQ_OSU_MSQ_OSU_AVQ_ASQ_AVQ_ASQ_OVQ_OSQ_VSQ) throws IOException, UnsupportedAudioFileException
	{
	    toplygin.toHead();
