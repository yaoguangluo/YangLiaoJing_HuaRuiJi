...
public class LogFFTcountRun extends OSU_AVQ_ASQ_OPE_OPC_ECI
{
	...
	public void run(final LogFFTcountView SQ_OSU_MSQ_OSU_AVQ_ASQ_AVQ_ASQ_OVQ_OSQ_VSQ) throws IOException, UnsupportedAudioFileException
	{
	toplygin.toHead();
