...
public class SoundWavePanelVector extends Panel implements Runnable{
	...
	public void paint2(Vector<Double> mlines) {
		...
		if (mlines != null) {
			...
			if(mlines.size()>2) {
				for (int i = 0; i < mlines.size(); i++) {
					Line2D  v=(Line2D) mlines.get(i);
					g2.drawLine((int)v.getX1()+10,350-20,(int)v.getX2()+10,(int)v.getY2()+350-20);      
				}
			}
		}
		g2.drawString("锐化熵", 0+10,  350+120-20);
		...
		if (mlines != null) {
			...
			if(mlines.size()>2) {
				for (int i= 0; i < mlines.size(); i++) {
					Line2D v= (Line2D) mlines.get(i);
					g3.drawLine((int)v.getX1()+10,350-20,(int)v.getX2()+10,(int)v.getY2()+350-20);      
				}
			}
		}
		g3.drawString("锐化熵", 0+10,  350+120-20);
	}

	public void paint3(Vector<Double> mlines) {
		g2.setColor(Color.black); 
		g2.clearRect(0,450+30-20, 300, 250);
		if (mlines != null) {
			g2.setColor(Color.yellow); 
			if(mlines.size()>2) {
				for (int i = 0; i < mlines.size(); i++) {
					Line2D  v=(Line2D) mlines.get(i);
					g2.drawLine((int)v.getX1()+10,500-20,(int)v.getX2()+10,(int)v.getY2()+500-20);      
				}
			}
		}
		g2.drawString("高斯过滤", 0+10,  500+120-20);
		...
		if (mlines != null) {
			...
			if(mlines.size()>2) {
				for(int i = 0; i < mlines.size(); i++) {
					Line2D  v=(Line2D) mlines.get(i);
					g3.drawLine((int)v.getX1()+10,500-20,(int)v.getX2()+10,(int)v.getY2()+500-20);      
				}
			}
		}
		g3.drawString("高斯过滤", 0+10,  500+120-20);
	}
	...
	public void paint5(Vector<Double> mlines) {
		...
		if (mlines != null) {
			...
			if(mlines.size()>2) {
				for (int i = 0; i < mlines.size(); i++) {
					Line2D  v=(Line2D) mlines.get(i);
					g2.drawLine((int)v.getX1()+260+10,350-20,(int)v.getX2()+260+10,(int)v.getY2()+350-20);          
				}
			}
		}
		g2.drawString("裁剪", 260+10,  350+120-20);
		...
		if (mlines != null) {
			...
			if(mlines.size()>2) {
				for(int i = 0; i < mlines.size(); i++) {
					Line2D  v=(Line2D) mlines.get(i);
					g3.drawLine((int)v.getX1()+260+10,350-20,(int)v.getX2()+260+10,(int)v.getY2()+350-20);          
				}
			}
		}
		g3.drawString("裁剪", 260+10,  350+120-20);
	}

	public void paint6(Vector<Double> mlines) {
		g2.setColor(Color.black); 
		g2.clearRect(260, 450+30-20, 300, 250);
		if (mlines!= null) {
			g2.setColor(Color.BLUE); 
			if(mlines.size()> 2) {
				for (int i= 0; i< mlines.size(); i++) {
					Line2D v= (Line2D) mlines.get(i);
					g2.drawLine((int)v.getX1()+ 260+ 10, 500-20, (int)v.getX2()+ 260+ 10, (int)v.getY2()+ 500-20);        
				}
			}
		}
		g2.drawString("平移", 260+10,  500+120-20);
		...
		if (mlines!= null) {
			...
			if(mlines.size()> 2) {
				for (int i= 0; i< mlines.size(); i++) {
					Line2D v= (Line2D) mlines.get(i);
					g3.drawLine((int)v.getX1()+ 260+ 10, 500-20, (int)v.getX2()+ 260+ 10, (int)v.getY2()+ 500-20);        
				}
			}
		}
		g3.drawString("平移", 260+10,  500+120-20);
	}
	...
	public void paint8(Vector<Double> mlines) {
		...
		if (mlines != null) {
			...
			if(mlines.size()>2) {
				for(int i = 0; i < mlines.size(); i++) {
					Line2D  v=(Line2D) mlines.get(i);
					g2.drawLine((int)v.getX1()+520+10,350-20,(int)v.getX2()+520+10,(int)v.getY2()+350-20);        
				}
			}
		}
		g2.drawString("截取拉伸", 520+10,  350+120-20);
		...
		if (mlines != null) {
			...
			if(mlines.size()>2) {
				for(int i = 0; i < mlines.size(); i++) {
					Line2D  v=(Line2D) mlines.get(i);
					g3.drawLine((int)v.getX1()+520+10,350-20,(int)v.getX2()+520+10,(int)v.getY2()+350-20);        
				}
			}
		}
		g3.drawString("截取拉伸", 520+10,  350+120-20);
	}

	public void paint9(Vector<Double> mlines) {
		g2.setColor(Color.black); 
		g2.clearRect(520,450+30-20, 500, 250+30);
		if (mlines != null) {
			g2.setColor(Color.red); 
			if(mlines.size()>2) {
				for (int i = 0; i < mlines.size(); i++) {
					Line2D  v=(Line2D) mlines.get(i);
					g2.drawLine((int)v.getX1()+520+10,500-20,(int)v.getX2()+520+10,(int)v.getY2()+500-20);         
				}
			}
		}
		g2.drawString("细化", 520+10,  500+120-20);
		...
		if (mlines != null) {
			...
			if(mlines.size()>2) {
				for (int i = 0; i < mlines.size(); i++) {
					Line2D  v=(Line2D) mlines.get(i);
					g3.drawLine((int)v.getX1()+520+10,500-20,(int)v.getX2()+520+10,(int)v.getY2()+500-20);         
				}
			}
		}
		g3.drawString("细化", 520+10,  500+120-20);
	}
	...
	public void paint11(Vector<Double> mlines) {
		g2.setColor(Color.black); 
		g2.clearRect(780,300+30-20, 500, 400); 
		if (mlines != null) {
			// .. render sampling graph ..
			...
			if(mlines.size()>2) {
				for (int i = 0; i < mlines.size(); i++) {
					Line2D  v=(Line2D) mlines.get(i);
					g2.drawLine((int)v.getX1()+780+10,350-20,(int)v.getX2()+780+10,(int)v.getY2()+350-20);       
				}
			}
		}
		g2.drawString("输出", 780+10,  350+120-20);
		...
		if (mlines != null) {
			...
			if(mlines.size()>2) {
				for (int i = 0; i < mlines.size(); i++) {
					Line2D  v=(Line2D) mlines.get(i);
					g3.drawLine((int)v.getX1()+780+10,350-20,(int)v.getX2()+780+10,(int)v.getY2()+350-20);       
				}
			}
		}
