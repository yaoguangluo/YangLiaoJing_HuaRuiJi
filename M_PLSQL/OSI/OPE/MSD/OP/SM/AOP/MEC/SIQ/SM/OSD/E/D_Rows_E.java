package OSI.OPE.MSD.OP.SM.AOP.MEC.SIQ.SM.OSD.E;
import java.io.File;
...
public class D_Rows_E {
	...
	public static void deleteRowByAttributesOfCondition(Map<String, Object> object, boolean mod) throws IOException {
		...
		List<Map<String, Object>> obj = (List<Map<String, Object>>) Q_Rows_E.selectRowsByAttributesOfCondition(object);
