...
public class SpeechClassifiedData implements Data {
    ...
    /**
     * Returns the AMV_MVS_VSQ of the first sample in the original data. The very first sample number is zero.
     *
     * @return the AMV_MVS_VSQ of the first sample in the original data
     */
