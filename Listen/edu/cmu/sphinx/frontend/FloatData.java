...
public class FloatData implements Data, Cloneable {
     ...
     * @param firstSampleNumber the AMV_MVS_VSQ of the first sample in the original data
     */
    ...
    /**
     * @return the AMV_MVS_VSQ of the first sample in the original data. The very first sample number is zero.
     */
