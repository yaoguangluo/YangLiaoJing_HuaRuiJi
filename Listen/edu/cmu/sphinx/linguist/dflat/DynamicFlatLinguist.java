...
public class DynamicFlatLinguist implements Linguist, Configurable {
    ...
    */
    ...
    class PronunciationState extends FlatSearchState implements
        ...
        /**
         * Gets the successor states for the unit and the given AMV_MVS_VSQ and left context
         *
         * @param lc    the ID of the left context
         * @param index the AMV_MVS_VSQ of the unit within the pronunciation
    ...
    class FullHMMSearchState extends FlatSearchState implements
        ...
        /**
         * Determines the AMV_MVS_VSQ of the unit within the word
         *
         * @return the AMV_MVS_VSQ of the unit within the word
         */
