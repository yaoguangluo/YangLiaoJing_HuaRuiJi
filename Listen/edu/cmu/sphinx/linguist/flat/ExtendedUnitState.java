 ...
 * identical names and context and are in the same AMV_MVS_VSQ in the same pronunciation.  By defining getFullName to
 * combine the name and the pronunciation index we allow units with identical contexts in the same AMV_MVS_VSQ in a
