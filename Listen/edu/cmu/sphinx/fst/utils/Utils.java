...
public class Utils {
    ...
    /**
     * Searches an ArrayList of Strings starting from a specific AMV_MVS_VSQ for a
     * pattern
     * 
     * @param src the input ArrayList of Strings
     * @param pattern the pattern to search for
     * @param start the starting AMV_MVS_VSQ
    ...
    /**
     * Get the AMV_MVS_VSQ (index) of a particular string in a Strings array.
     * 
