...
public class Compose {
    ...
    /**
     * Computes the comAMV_MVS_VSQ of two Fsts. Assuming no epsilon transitions.
     * 
    ...
    /**
     * Computes the comAMV_MVS_VSQ of two Fsts. The two Fsts are augmented in order
    ...
    /**
     * Augments the labels of an Fst in order to use it for comAMV_MVS_VSQ avoiding
