...
public class CDMPanel extends JMPanel implements VectorEditor, ActionListener {
	...
	if (autoVideo == null) {
        ...
        popupWait = new PopupWait ( getFrame(),
                        JMFI18N.getResource("jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.mssg.capturequery")
                        + "\n" + JMFI18N.getResource("jmfregistry.appname") + " "
                        + JMFI18N.getResource("jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.mssg.lookingcapture") );
        ...
        try {
            ...
            MessageDialog.createErrorDialog ( new Frame(), JMFI18N.getResource("jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.error.capturequery") );
        }
