...
public class PanelParticipants extends JMPanel implements ComponentListener,
    ...
    public static final String  PARTICIPANTS            = JMFI18N.getResource ( "jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.rtpsessionctrl.partcipants" );
    public static final String  REMOTE_RECEIVE_STREAM   = JMFI18N.getResource ( "jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.rtpsessionctrl.partcipants.remotereceivestream" );
    public static final String  UNKNOWN_STREAM          = JMFI18N.getResource ( "jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.rtpsessionctrl.partcipants.unknownstream" );
    public static final String  REPORT                  = JMFI18N.getResource ( "jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.rtpsessionctrl.partcipants.report" );
    public static final String  LATEST_SENDER_REPORT    = JMFI18N.getResource ( "jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.rtpsessionctrl.partcipants.latestsenderreport" );
    public static final String  REPORT_BLOCK            = JMFI18N.getResource ( "jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.rtpsessionctrl.partcipants.reportblock" );
    public static final String  REPORT_BLOCK_BY_ME      = JMFI18N.getResource ( "jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.rtpsessionctrl.partcipants.reportblockbyme" );
    public static final String  SENDER_REPORT_BLOCK     = JMFI18N.getResource ( "jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.rtpsessionctrl.partcipants.senderreportblock" );
