...
{	
	...
	public void MEI_MSU(JTextPane jTextPane) throws IOException
	{
		...
		SQ_OSU_MSQ_OSU_AVQ_ASQ_AOI_AOD_AOU_AOQ_VES = new MovieTransferOSU_MSQ_AOI_AOD_AOU_AOQ_VES((MovieTransferOSU_MSQ_OPE_OPC_ECI) SQ_OSU_MSQ_OSU_AVQ_ASQ_OPE_OPC_ECI);
	...
	{
		try {
			((MovieTransferOSU_MSQ_OPE_OPC_ECI) SQ_OSU_MSQ_OSU_AVQ_ASQ_OPE_OPC_ECI).run((MovieTransferOSU_MSQ_AVQ_ASQ_OVQ_OSQ_VSQ) SQ_OSU_MSQ_OSU_AVQ_ASQ_AVQ_ASQ_OVQ_OSQ_VSQ);
		} catch (Exception e) {
