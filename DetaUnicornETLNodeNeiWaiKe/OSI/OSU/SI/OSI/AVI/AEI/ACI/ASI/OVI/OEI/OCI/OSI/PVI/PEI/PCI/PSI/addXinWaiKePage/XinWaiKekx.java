...
public class XinWaiKekx extends Container implements MouseListener, KeyListener{
	...
	private int row;
	public XinWaiKekx(JTextPane text, Analyzer analyzer, Map<String, String> pos, Map<String, String> pose
