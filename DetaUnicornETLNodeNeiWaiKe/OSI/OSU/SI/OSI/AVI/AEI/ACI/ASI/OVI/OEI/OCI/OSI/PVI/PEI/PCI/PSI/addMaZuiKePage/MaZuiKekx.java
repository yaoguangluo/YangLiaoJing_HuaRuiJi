...
public class MaZuiKekx extends Container implements MouseListener, KeyListener{
	...
	public Object[] columnTitle = {"ID", "打分", "病症名", "原书笔记", "概念", "流行病学",
			...
			"治疗&治疗方案&原则", "麻醉", "预后&影响", "预防", "影像与检查"};  
	public JTextPane text;
	public JTabbedPane jTabbedpane;
	public App app;
	public ReadChinese readChinese;
	private int row;
	public MaZuiKekx(JTextPane text, Analyzer analyzer, Map<String, String> pos, Map<String, String> pose
