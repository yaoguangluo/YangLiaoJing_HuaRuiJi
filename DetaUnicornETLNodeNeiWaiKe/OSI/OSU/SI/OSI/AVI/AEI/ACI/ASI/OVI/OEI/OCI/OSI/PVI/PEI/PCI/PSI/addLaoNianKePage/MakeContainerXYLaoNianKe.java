...
public class MakeContainerXYLaoNianKe extends Thread implements Runnable{
	...
	public MakeContainerXYLaoNianKe(Analyzer analyzer, Container jpanelSecond, App u2, JTabbedPane jTabbedpane
	...
	public void run(){ 
		try {
			...
			Thread.sleep(1000*3);
			tabNames.add("老年科");
			laoNianKekx= new LaoNianKekx(u.text, this.analyzer, pos, pose, etc, cte, jTabbedpane, u);
			laoNianKekx.setName("老年科");
			
//			u.jpanel11 = new MakeContainerXYLaoNianKe(u.text, this.analyzer, pos, pose, etc, cte, jTabbedpane, u);
