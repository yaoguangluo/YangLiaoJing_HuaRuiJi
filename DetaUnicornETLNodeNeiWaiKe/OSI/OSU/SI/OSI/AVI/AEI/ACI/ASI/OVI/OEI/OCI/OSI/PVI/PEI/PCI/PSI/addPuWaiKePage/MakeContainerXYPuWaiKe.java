...
public class MakeContainerXYPuWaiKe extends Thread implements Runnable{
	...
	public MakeContainerXYPuWaiKe(Analyzer analyzer, Container jpanelSecond, App u2, JTabbedPane jTabbedpane
	...
	public void run(){ 
		try {
			...
			Thread.sleep(1000*3);
			tabNames.add("普外科");
			jpanelSecond= new PuWaiKekx(u.text, this.analyzer, pos, pose, etc, cte, jTabbedpane, u);
			jpanelSecond.setName("普外科");
			
//			u.jpanel11 = new MakeContainerXYPuWaiKe(u.text, this.analyzer, pos, pose, etc, cte, jTabbedpane, u);
//			u.jpanel11.setName(tabNames.get(10));
			jTabbedpane.addTab("普外科", new ImageIcon() ,jpanelSecond, "添加普外科页");// �����һ��ҳ��  
