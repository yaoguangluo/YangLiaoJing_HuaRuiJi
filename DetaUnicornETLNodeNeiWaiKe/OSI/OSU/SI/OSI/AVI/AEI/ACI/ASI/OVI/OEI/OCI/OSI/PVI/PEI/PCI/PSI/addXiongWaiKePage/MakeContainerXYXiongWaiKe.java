...
public class MakeContainerXYXiongWaiKe extends Thread implements Runnable{
	...
	public MakeContainerXYXiongWaiKe(Analyzer analyzer, Container jpanelSecond, App u2, JTabbedPane jTabbedpane
	...
	public void run(){ 
		try {
			...
			Thread.sleep(1000*3);
			tabNames.add("胸外科");
			jpanelSecond= new XiongWaiKekx(u.text, this.analyzer, pos, pose, etc, cte, jTabbedpane, u);
			jpanelSecond.setName("胸外科");
			
//			u.jpanel11 = new MakeContainerXYXiongWaiKe(u.text, this.analyzer, pos, pose, etc, cte, jTabbedpane, u);
