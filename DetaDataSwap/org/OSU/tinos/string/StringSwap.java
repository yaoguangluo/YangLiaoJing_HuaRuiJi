...
public class StringSwap{
	...
	public static String uRIencodeToURIdecode(String string, String encode) throws UnsupportedEncodingException{
		return java.net.URLDecoder.decode(string, encode);
	}
