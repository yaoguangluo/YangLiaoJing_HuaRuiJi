package OSI.OSU.tinos.stable;
public interface Stable {
	public static final String DOUBLE_INDICATION_NULL= "NULL";
	public static final String DOUBLE_INDICATION_TIVE= "TIVE";
	public static final String SUPPRESS_WARNINGS_DEPRECATION
	= "deprecation";
	public static final String SUPPRESS_WARNINGS_STATIC_ACCESS
	= "static-access";
	public static final String INVALID_DOUBLE_FORMAT
