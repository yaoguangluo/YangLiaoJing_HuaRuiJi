...
public class MakeContainerXYBuYunBuYuKe extends Thread implements Runnable{
	...
	public MakeContainerXYBuYunBuYuKe(Analyzer analyzer, Container jpanelSecond, App u2, JTabbedPane jTabbedpane
	...
	public void run(){ 
		try {
			...
			Thread.sleep(1000* 3);
			tabNames.add("不孕不育科");
			jpanelSecond= new BuYunBuYuKekx(u.text, this.analyzer, pos, pose, etc, cte, jTabbedpane, u);
			jpanelSecond.setName("不孕不育科");
			
//			u.jpanel11= new MakeContainerXYBuYunBuYuKe(u.text, this.analyzer, pos, pose, etc, cte, jTabbedpane, u);
