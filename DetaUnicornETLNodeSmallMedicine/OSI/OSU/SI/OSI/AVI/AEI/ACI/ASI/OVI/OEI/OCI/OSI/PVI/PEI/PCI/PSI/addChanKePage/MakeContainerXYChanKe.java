...
public class MakeContainerXYChanKe extends Thread implements Runnable{
	...
	public MakeContainerXYChanKe(Analyzer analyzer, Container jpanelSecond, App u2, JTabbedPane jTabbedpane
	...
	public void run(){ 
		try {
			...
			Thread.sleep(1000*3);
			tabNames.add("西医产科");
			jpanelSecond= new ChanKekx(u.text, this.analyzer, pos, pose, etc, cte, jTabbedpane, u);
			jpanelSecond.setName("西医产科");
			
//			u.jpanel11 = new MakeContainerXYChanKe(u.text, this.analyzer, pos, pose, etc, cte, jTabbedpane, u);
//			u.jpanel11.setName(tabNames.get(10));
			jTabbedpane.addTab("西医产科", new ImageIcon() ,jpanelSecond, "添加西医产科页");// �����һ��ҳ��  
