...
public class MakeContainerXYWeiChanKe extends Thread implements Runnable{
	...
	public MakeContainerXYWeiChanKe(Analyzer analyzer, Container jpanelSecond, App u2, JTabbedPane jTabbedpane
	...
	public void run(){ 
		try {
			...
			Thread.sleep(1000*3);
			tabNames.add("围产科");
			jpanelSecond= new WeiChanKekx(u.text, this.analyzer, pos, pose, etc, cte, jTabbedpane, u);
			jpanelSecond.setName("围产科");
			
//			u.jpanel11 = new MakeContainerXYWeiChanKe(u.text, this.analyzer, pos, pose, etc, cte, jTabbedpane, u);
