...
public class MakeContainerXYNanXinJiYinKe extends Thread implements Runnable{
	...
	public MakeContainerXYNanXinJiYinKe(Analyzer analyzer, Container jpanelSecond, App u2, JTabbedPane jTabbedpane
	...
	public void run(){ 
		try {
			...
			Thread.sleep(1000*3);
			tabNames.add("男性基因科");
			jpanelSecond= new NanXinJiYinKekx(u.text, this.analyzer, pos, pose, etc, cte, jTabbedpane, u);
			jpanelSecond.setName("男性基因科");
			
//			u.jpanel11 = new MakeContainerXYNanXinJiYinKe(u.text, this.analyzer, pos, pose, etc, cte, jTabbedpane, u);
//			u.jpanel11.setName(tabNames.get(10));
			jTabbedpane.addTab("男性基因科", new ImageIcon() ,jpanelSecond, "添加男性基因科页");// �����һ��ҳ��  
