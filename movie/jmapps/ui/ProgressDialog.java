...
public class ProgressDialog extends JMDialog {
    ...
    public static final String    ACTION_ABORT = JMFI18N.getResource("jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.saveprogress.abort");
    public static final String    ACTION_STOP  = JMFI18N.getResource("jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.saveprogress.stop");
    public static final String    ACTION_PAUSE = JMFI18N.getResource("jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.saveprogress.pause");
    public static final String    ACTION_RESUME = JMFI18N.getResource("jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.saveprogress.resume");
    ...
    public void setCurPos ( int nPos ) {
        if ( progressBar != null ) {
            ...
            labelProgress.setText ( JMFI18N.getResource("jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.saveprogress.saved")
                                + " " + nPos + " "
                                + JMFI18N.getResource("jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.saveprogress.seconds") + "...");
        }
    }
