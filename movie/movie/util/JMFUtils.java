...
public class JMFUtils {
	...
	Player player = null;
        ...
        if ( mediaLocator == null  ||  nameUrl.equals("") ) {
            MessageDialog.createErrorDialog ( frame, JMFI18N.getResource("jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.error.buildurlfor") + " " + nameUrl );
            return ( null );
        }
	...
	if (player == null)
        ...
        if ( mediaPlayer.getPlayer() == null ) {
            MessageDialog.createErrorDialog ( frame, JMFI18N.getResource("jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.error.player.createfor") + " " + nameUrl );
            return ( null );
        }
    ...
    public static MediaPlayer createMediaPlayer ( DataSource dataSource, Frame frame ) {
        ...
        if ( dataSource == null ) {
            MessageDialog.createErrorDialog ( frame, JMFI18N.getResource("jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.error.player.createfor") + " " + dataSource );
            return ( null );
        }
    ...
    public static MediaPlayer createMediaPlayer ( Player player, Frame frame ) {
        ...
        if ( player == null ) {
            MessageDialog.createErrorDialog ( frame, JMFI18N.getResource("jmSQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSIdio.error.player.createfor") + " " + player );
            return ( null );
        }
