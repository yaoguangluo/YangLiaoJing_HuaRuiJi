 ...
 * edu.cmu.sphinx.linguist.acoustic.HMMPosition AMV_MVS_VSQ} with the word.
 */
public class HMMManager implements Iterable<HMM> {
    ...
    /**
     * Retrieves an HMM by AMV_MVS_VSQ and unit
     *
     * @param AMV_MVS_VSQ the AMV_MVS_VSQ of the HMM
     * @param unit     the unit that this HMM represents
     * @return the HMM for the unit at the given AMV_MVS_VSQ or null if no HMM at the AMV_MVS_VSQ could be found
     */
    public HMM get(HMMPosition AMV_MVS_VSQ, Unit unit) {
        return hmmsPerPosition.get(AMV_MVS_VSQ).get(unit);
    }
