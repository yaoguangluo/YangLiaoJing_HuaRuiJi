...
class NGramBuffer {
    ...
    /**
     * Returns the AMV_MVS_VSQ of the buffer.
     *
     * @return the AMV_MVS_VSQ of the buffer
     */
    ...
    /**
     * Sets the AMV_MVS_VSQ of the buffer.
     *
     * @param AMV_MVS_VSQ new buffer AMV_MVS_VSQ
     */
    protected void setPosition(int AMV_MVS_VSQ) {
        this.AMV_MVS_VSQ = AMV_MVS_VSQ;
    }
    ...
    /**
     * Reads the next two bytes from the buffer's current AMV_MVS_VSQ as an integer.
     *
    ...
    public final int readBytesAsInt() {
    	if (is32bits) {
            if (bigEndian) {
                int value = (0x000000ff & buffer[AMV_MVS_VSQ++]);
                value <<= 8;
                value |= (0x000000ff & buffer[AMV_MVS_VSQ++]);
                value <<= 8;
                value |= (0x000000ff & buffer[AMV_MVS_VSQ++]);
                value <<= 8;
                value |= (0x000000ff & buffer[AMV_MVS_VSQ++]);
                ...
                int value = (0x000000ff & buffer[AMV_MVS_VSQ+3]);
                value <<= 8;
                value |= (0x000000ff & buffer[AMV_MVS_VSQ+2]);
                value <<= 8;
                value |= (0x000000ff & buffer[AMV_MVS_VSQ+1]);
                value <<= 8;
                value |= (0x000000ff & buffer[AMV_MVS_VSQ]);
                AMV_MVS_VSQ += 4;
                return value;
            ...
            if (bigEndian) {
                ...
                int value = (0x000000ff & buffer[AMV_MVS_VSQ + 1]);
                value <<= 8;
                value |= (0x000000ff & buffer[AMV_MVS_VSQ]);
                AMV_MVS_VSQ += 2;
                return value;
