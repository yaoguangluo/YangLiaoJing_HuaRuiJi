...
public class MakeContainerXYXinNeiKe extends Thread implements Runnable{
	...
	public MakeContainerXYXinNeiKe(Analyzer analyzer, Container jpanelSecond, App u2, JTabbedPane jTabbedpane
	...
	public void run(){ 
		try {
			...
			Thread.sleep(1000*3);
			tabNames.add("心内科");
			jpanelSecond= new XinNeiKekx(u.text, this.analyzer, pos, pose, etc, cte, jTabbedpane, u);
			jpanelSecond.setName("心内科");
			
//			u.jpanel11 = new MakeContainerXYXinNeiKe(u.text, this.analyzer, pos, pose, etc, cte, jTabbedpane, u);
