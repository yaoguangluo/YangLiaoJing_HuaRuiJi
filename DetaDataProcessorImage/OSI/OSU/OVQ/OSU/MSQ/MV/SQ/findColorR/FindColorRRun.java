package OSI.OSU.OVQ.OSU.MSQ.MV.SQ.findColorR;
...
public class FindColorRRun extends OSU_AVQ_ASQ_OPE_OPC_ECI{
	...
	public void run(final FindColorRView SQ_OSU_MSQ_OSU_AVQ_ASQ_AVQ_ASQ_OVQ_OSQ_VSQ) throws IOException{
