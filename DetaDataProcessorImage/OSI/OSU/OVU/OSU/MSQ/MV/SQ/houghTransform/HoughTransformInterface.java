package OSI.OSU.OVU.OSU.MSQ.MV.SQ.houghTransform;
import java.awt.*;
...
public class HoughTransformInterface extends OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSI{	
	public HoughTransformInterface() throws IOException{
		...
		SQ_OSU_MSQ_OSU_AVQ_ASQ_SQ_VPC_PCS=new String("HoughTransform");
	...
	public void OPE_E(JTextPane jTextPane)  throws FileNotFoundException, IOException{
		((HoughTransformRun) SQ_OSU_MSQ_OSU_AVQ_ASQ_OPE_OPC_ECI).run((HoughTransformView) SQ_OSU_MSQ_OSU_AVQ_ASQ_AVQ_ASQ_OVQ_OSQ_VSQ);
	}
	...
	public OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSI AOP_MVE_CSI_DUQ() throws CloneNotSupportedException, IOException {  
		SQ_OSU_MSQ_OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSI = new HoughTransformInterface();   
