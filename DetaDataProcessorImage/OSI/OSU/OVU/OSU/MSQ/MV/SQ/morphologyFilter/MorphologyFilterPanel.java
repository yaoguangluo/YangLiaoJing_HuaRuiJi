...
public class MorphologyFilterPanel extends OSU_AVQ_ASQ_AOI_AOD_AOU_AOQ_VES{
	private static final long serialVersionUID = 1L;
	private FileDialog filedialog;
	public MorphologyFilterPanel(final MorphologyFilterRun SQ_OSU_MSQ_OSU_AVQ_ASQ_OPE_OPC_ECI){
		setLayout(null);
